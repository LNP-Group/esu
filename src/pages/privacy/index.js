            ...
            <main className={styles.main}>
                <div className={styles.privacyContent}>
                    ...
                    <div className={styles.introduction}>
                        <p>
                            ESU Franchise ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how your personal
                            information is collected, used, and disclosed by ESU Franchise.
                        </p>
                        <p>
                            This Privacy Policy applies to our website, https://esu.lnp-group.com, and its associated subdomains (collectively, our "Service")
                    ...
                    <section id="definitions">
                        ...
                        <div className={styles.content}>
                            ...
                            <ul>
                                ...
                                <li>
                                    <strong>Company:</strong> when this policy mentions "Company," "we," "us," or "our," it refers to LNP Group, Str. Dr. Ghe. Buzoianu, Nr. 3, 805200, Târgu Bujor. that is responsible for your information under this Privacy Policy.
                                </li>
                                <li>
                    ...
                    <section id="cookies">
                        <h2 className={styles.sectionHeader}>Cookiesy</h2>
                        <div className={styles.content}>
                            < p className={styles.summary}>
